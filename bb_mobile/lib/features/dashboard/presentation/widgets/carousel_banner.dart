import 'package:bb_mobile/features/dashboard/presentation/provider/carousel_provider.dart';
...
class _CarouselBannerState extends ConsumerState<CarouselBanner> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(carouselProvider.notifier).fetchCarousel());
  }
